				...
				\begin{nbox}[\textwidth]{\textbf{Need for fast solvers}}
                                  ...
                                  \begin{figure}
                                    ...
                                    \caption{Optimal TV$-\ell_1$ brain maps for the face-house discrimination task on
                                      the HAXBY2001 dataset, for different levels of tolerance. \textcolor{cyan}{\cite{dohmatob2014benchmarking}}}%
			...
			\begin{column}{.48\linewidth}
			  \begin{nbox}[\textwidth]{\textbf{Results of benchmarks}}
                            ...
                            \begin{figure}
                              ...
                              \caption{Benchmarks on HAXBY2001 dataset. \textbf{Top}: Least squares regression. \textbf{Bottom}: Logistic. %% \textbf{Top}:
