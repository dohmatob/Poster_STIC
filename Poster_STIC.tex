...
\author{DOHMATOB, GRAMFORT, THIRION, VAROQUAUX}						% Nom des auteurs 
		...
		\begin{columns}[t]
			...
			\begin{column}{.48\linewidth}
				...
				\begin{sxbox}[\textwidth]{\textbf{Problem statement}}
                                  ...
                                  \begin{itemize}
                                    ...
                                    \item  \textcolor{blue}{$\alpha \left(\rho \|w\|_1 + \left(1-\rho\right)TV(w)\right)$} is the \textcolor{blue}{\textit{regularization}}
                                      (aka \textit{penalty}) term \textcolor{cyan}{\citep{baldassarre2012,michel2011,abraham2013}}:
                                    \begin{itemize}
				...
				\begin{nbox}[\textwidth]{\textbf{Need for fast solvers}}
                                  ...
                                  \item Lack of good solver and explicit control of
                                  ...
                                  \begin{figure}
                                    ...
                                    \caption{TV$-\ell_1$ maps ($\hat{w}$) for the face-house discrimination task on
                                      the HAXBY2001 dataset, for different levels of \textcolor{orange}{tolerance}. \textcolor{cyan}{\cite{dohmatob2014benchmarking}}}%
			  ...
			  \begin{nbox}[\textwidth]{\textbf{Benchmarks}}
                            ...
                            \begin{figure}
                              ...
                              \caption{TV$-\ell_1$ penalized Least-Squares Regression. \textbf{Top}:
                                ...
                                indicates the best model selected by cross-validation. \textcolor{cyan}{\cite{dohmatob2014benchmarking}}}
                              \label{Fig:MSEtimes}
                            \end{figure}
