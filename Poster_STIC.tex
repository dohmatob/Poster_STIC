		...
		\begin{columns}[t]
			...
			\begin{column}{.48\linewidth}
				...
				\begin{sxbox}[\textwidth]{\textbf{Problem statement}}
                                  ...
                                  \begin{itemize}
                                    ...
                                    \item  \textcolor{blue}{$\alpha \left(\rho \|w\|_1 + \left(1-\rho\right)TV(w)\right)$} is the \textcolor{blue}{\textit{regularization}}
                                      (aka \textit{penalty}) term \textcolor{cyan}{\cite{michel2011}}:
                                    \begin{itemize}
                                  ...
                                  % \hline
                                \textcolor{magenta}{\textbf{Problem (1) is a high-dimensional non-smooth convex optimization problem and calls for novel optimization techniques.}}
				...
				\begin{nbox}[\textwidth]{\textbf{Need for fast solvers}}
                                  ...
                                  \end{figure}
                                  \begin{itemize}
                                  \item \textcolor{magenta}{Lack of good solver and explicit control of
                                    ...
                                    \item \textcolor{magenta}{We focus on convergence time for small tolerance}
                                  \end{itemize}
                                  \end{nbox}
			\end{column}
			\hfill
