...
\author{Elvis DOHMATOB \inst{1}, Alexandre GRAMFORT, Bertrand THIRION \inst{1}, Gael VAROQUAUX \inst{1}}				% Nom des auteurs 
\institute{\inst{1} INRIA, Saclay-\^Ile-de-France, Parietal
team, France - CEA / DSV / I2BM / Neurospin / Unati \and %
			...
			\begin{column}{.48\linewidth}
				...
				\begin{nbox}[\textwidth]{\textbf{Need for fast solvers}}
                                  ...
                                  \begin{figure}
                                    ...
                                    \llap{\color{white}\raisebox{.161\linewidth}{\rlap{\sffamily %% Stopping:
